...
//       <TouchableOpacity style={styles.checkoutBtn} onPress={()=>navigation.navigate('Address Page')}>
  ...
  const [items, setItems] = useState([
    {
      ...
      qty: 1,
      image:
        "https://upload.wikimedia.org/wikipedia/commons/5/5c/Jollof_rice.jpg",
    },
    {
      id: "2",
      name: "Chicken lollipop",
