...
export default function PaymentScreen({navigation}) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('OrderSummary Page')} >
  ...
  <View style={styles.modalOverlay}>
    <View style={styles.modalView}>
      ...
      <Text style={styles.modalText}>Your order has been placed successfully</Text>
        <Text style={styles.modalText}>Estimated delivery time: 2:40 PM</Text>
      <View style={styles.modalButtons}>
        <TouchableOpacity onPress={() => setModalVisible(false)} style={styles.modalButton}>
          <Text style={styles.modalButtonText}>Back</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => navigation.navigate('Home Page')} style={styles.modalButton}>
